...
public:
	 ...
	 * Constructor
	 */
	BlurGenerator(const std::string startingResultsFilename, const std::string generatedResultsFilename,
			const int numSamples, const double blurRadius) :
